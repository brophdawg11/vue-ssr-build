...
For ease of use, this repository also provides `babel.config.js`, `.eslintrc.js` and `jest.config.js` files that should work with the default configurations.  Simply import them into your configs an extend as needed.
